...
你说人来这一世上，是否要把一半还于天地？我是在高中的时候被舍友推荐才知道这样一位现代诗诗人，他的诗真的就像歌谣一样朗朗上口，并且还带有一点民间歌谣的哲理性！扯远了……

目前对于博客的规划，我主要设置了三个**文件夹**：
...
除此以外，你还可以从我下面配置好的**数据库**或者**关系图谱**中点进你想要查看的笔记。关于笔记的创建时间、修改时间以及上次更新字段，由于我的笔记是从另一个笔记库里复制过来的，所以笔记的创建时间并不准确，而修改时间和上次更新则是根据 git push 到 github 的时间算的 (甚至不是北京时间)，因此虽然有一定的参考价值，但与现实情况并不一致。
